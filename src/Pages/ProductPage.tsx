...
import ProductSlider from '../Components/PruductSlider/ProductSlider'
import FavoriteBorderIcon from '@mui/icons-material/FavoriteBorder';
import img from '../img/Vector.png'
import ProductPageTabs from '../Components/Tabs/ProductPageTabs';
import SimilarProducts from '../Components/SimilarItems/SimilarProducts';
...
export default function ProductPage() {
  ...
  return (
    <>
        <BreadCrumbs/>
        <section className="container lg:px-[200px] flex flex-col xl:flex-row gap-5 mb-10">
