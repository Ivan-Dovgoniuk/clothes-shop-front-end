...
import { checkProductStatus } from '../../hooks/checkProductStatus.hook';
...
export const ProductItem:FC<IProduct> = ({_id,name,thumbnail,price,sale,new_price,isNewProduct,isLoading})=>{
    ...
    const checkProductInCart = checkProductStatus(cart,setProductInCart,_id)
    const checkProductIsFavorite = checkProductStatus(favoriteProducts,setIsFavorite,_id)
